...
const AssemblyQCScanningPointPage = async ({
    ...
    const productDefects = await fetchProductDefectsWithOperations({ qcPointId: qcPoint.id, part: "button", obbSheetId: params.obbSheetId });
    ...
    return (
        <ProductQCDashboardPanel
            part="button"
            route="/points/button-section-qc"
            obbSheetId={params.obbSheetId}
