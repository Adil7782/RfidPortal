...
const AssemblyQCScanningPointPage = async ({
    ...
    const productDefects = await fetchProductDefectsWithOperations({ qcPointId: qcPoint.id, part: "line-end", obbSheetId: params.obbSheetId });
    ...
    return (
        <ProductQCDashboardPanel
            ...
            dailyTarget={target ? target.endQcTarget : null}
        />
    );
}
