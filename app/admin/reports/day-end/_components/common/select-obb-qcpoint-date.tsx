...
interface SelectObbQcPointDateProps {
    scanningPoints: {
        id: string;
        name: string;
        pointNo: number;
...
const SelectObbQcPointDate = ({
    scanningPoints,
    handleSubmit
}: SelectObbQcPointDateProps) => {
                                                    ...
                                                    <CommandList>
                                                        ...
                                                        <CommandGroup>
                                                            {scanningPoints && scanningPoints.map((point) => {
                                                                if (point.pointNo === 5 || point.pointNo === 6 || point.pointNo === 8 || point.pointNo ===9) {
                                                                    return (
                                                                        <CommandItem
                                                                            key={point.id}
                                                                            value={point.name}
...
export default SelectObbQcPointDate