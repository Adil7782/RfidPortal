...
import { ProductionDetailsType } from "./analytics";
// import { ProductionDataType } from "./LogTable";


export async function getData()  : Promise<ProductionDetailsType[]>   {
    ...
    return new Promise((resolve) => resolve(data as ProductionDetailsType[]  ))
}
