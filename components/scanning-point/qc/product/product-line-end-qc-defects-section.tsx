...
interface ProductLineEndQCDefectsSectionProps {
    part: string;
    obbSheetId: string
...
const ProductLineEndQCDefectsSection = ({
    part,
    obbSheetId,
    qcPointId,
    defects,
    obbOperations
}: ProductLineEndQCDefectsSectionProps) => {
...
export default ProductLineEndQCDefectsSection